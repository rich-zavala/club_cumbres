			...
			<ul class="list-group">
				...
				<li class="list-group-item cat-equipos">
					<div class="btn-group pull-right marginLeft10">
						...
						<a class="btn btn-xs btn-primary" href="<?=base() . 'torneo/equipos/listado/' . $info->ID_Torneo . '/' . $cat->ID_CatTorn . suffix()?>" title="Gestiona los equipos de esta categoría"><i class="fa fa-fw fa-users"></i> <?=$equiposCantidad?></a>
					</div>
