			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h4 class="panel-title">
						<a data-toggle="collapse" data-parent="#accordion" href="#collapseTorneo<?=$k?>" aria-expanded="false" class="no-click"><?=$torneo_info['nombre']?></a>
					</h4>
				</div>
				<div id="collapseTorneo<?=$k?>" class="panel-collapse collapse" role="tabpanel">
					<div class="panel-body">
						<ul class="list-group margin0">
							...
							<li class="list-group-item paddingTop5 paddingBottom5 <?=$trColor?>"><a href="#" class="btn btn-xs btn-success marginRight10 btn-importar" data-torneo="<?=htmlentities($torneo_info['nombre'])?>" data-equipo="<?=$r->NomEquipo?>" data-id="<?=$r->ID_Equipo?>"><i class="fa fa-arrow-left"></i></a> <?=$r->NomEquipo?></li>
							<?php } ?>
						</ul>
					</div>
				</div>
